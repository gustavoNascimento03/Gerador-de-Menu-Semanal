            ...
            <div className={styles.containerGeral}>
                <div className={styles.campoTextoTerceiro}>
                    ...
                    <p className={styles.paragrafoTerceiro}>
                        Funcionalidades pensadas para simplificar sua vida na
                        cozinha.
                    </p>
                </div>
                ...
                <div className={styles.containerFeatures}>
                    ...
                    <div className={styles.featuresCampo}>
                        ...
                        <p className={styles.paragrafoQuarto}>
                            Não gostou de uma sugestão? Troque qualquer refeição
                    ...
                    <div className={styles.featuresCampo}>
                        ...
                        <p className={styles.paragrafoQuarto}>
                            Gere e copie sua lista de compras da semana, pronta
                            para enviar ou levar ao mercado.
                        </p>
                    </div>
                </div>
            </div>
